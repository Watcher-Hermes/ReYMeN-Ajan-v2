...
description: 'Deep-read academic papers with MinerU Cloud extraction, LLM analysis,
  and NotebookLM key figure analysis. Outputs: Markdown notes + HTML + per-figure
  analysis files. Activates on /paper-deep-reader, ''deep read this paper'', ''精读论文'',
  ''解读论文'', ''分析这篇论文'', ''读一下这篇paper'', ''帮我读这篇PDF'', ''帮我读一下这篇论文'', ''解读一下这篇论文'',
  ''帮我解读这篇论文'', ''读一下这个PDF'', ''组会汇报'', ''帮我速读这篇论文'', ''快速总结一下这篇论文'', ''批量速读'', ''论文速读'',
  ''读一下文件夹中的论文'', ''帮我读一下这些论文'', ''帮我处理一下文件夹中的论文'', ''总结论文和专利'', ''分析这些专利'', DOI input,
  arXiv URL input, or any PDF attachment with a reading/analysis request.'
tags:
- academic
- research
category: Research
