...
description: 'Communication norms for this user in messaging-terminal style chat:
...
- **Hedef-ayrim kuralı (kritik)**: "kopyala", "gönder", "sana gönder", "bana gönder" gibi ifadeler = metni burada (ReYMeN sohbetinde) göster, kullanıcı kopyalasın. VS Code/Claude Code'a otomatik gönderme YAPMA. Sadece "VS Code'a yaz", "Claude terminaline yaz", "agent'a yaz", "imlec getir" gibi AÇIK hedef belirtilen ifadelerde vscode_yaz.bat kullan. "sana denileni yap kopyala" = kopyalanacak metni buraya yaz, VS Code'a gitme. İhlal = kullanıcının "sana gönder demek" diyerek düzeltmesi.
