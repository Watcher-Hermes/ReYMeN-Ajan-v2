...
| **Nerede** | `reymen\varsayilan_yeni_alan_kesfi.md` |
| **Ne Zaman** | ReYMeN sistemi yapilandirmasi gerektiginde |
| **Neden** | Varsayilan Yeni Alan Kesfi islemini standartlastirmak icin |
...
Nerede: `reymen\varsayilan_yeni_alan_kesfi.md`
Ne Zaman: ReYMeN sistemi yapilandirmasi gerektiginde
Neden: Varsayilan Yeni Alan Kesfi islemini standartlastirmak ve tekrarlanabilir kilmak icin
Nasil: Skill dosyasindaki adimlari takip ederek


# varsayilan_yeni_alan_kesfi

[SelfImprove] Skor: 7.0/10 | Varsayilan yeni_alan_kesfi yontemi
...
```python
# yeni_alan_kesfi icin temel cozum
pass
```
