...
description: 'ReYMeN Agent yedekleme: memory (MEMORY.md + USER.md), skills, config,
  state.db GitHub''a yedeklenir. İki yöntem: (1) gh CLI ile basit memory yedek, (2)
  full backup scripti ile skills+state.db+memory.'
tags:
- automation
- devops
- git
