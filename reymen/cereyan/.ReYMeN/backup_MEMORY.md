...
§
Kullanıcının GitHub hesabı: https://github.com/Izleyici-ReYMeN (eski adı: asdafgf, değiştirildi). Repolar: ReYMeN-gemini-copilot, wifi-ag-tarayici, runners-journey. GitHub içeriği hem ReYMeN skill hem Obsidian notu olarak daima referans gösterilebilir.
§
...
§
KURAL - Yeni GitHub reposu eklenince: (1) KURULACAK_REPOLAR.md güncelle, (2) commit+push, (3) Obsidian notu güncelle, (4) ReYMeN-kurulacak-repolar skill güncelle.
§
...
§
GitHub backup repo durumu (2026-06-14): Kullanıcı adı `asdafgf` → `Izleyici-ReYMeN` olarak değiştirilmiş. Skills backup repo remote URL hala `asdafgf/ReYMeN-skills` kullanıyor (404). Local backup `/c/Users/marko/ReYMeN-skills-backup/` commit'li ama push edilemiyor — remote URL `Izleyici-ReYMeN` olarak güncellenmeli. Obsidian vault `Watcher-ReYMeN/obsidian-vault` reposu çalışıyor. MEMORY.md/USER.md yedekleri Obsidian `08-Backup/` klasöründe.
§
GitHub hesap durumu: asdafgf kullanıcı adı 404 dönüyor (silinmiş/yeniden adlandırılmış). Tüm GitHub işlemleri Watcher-ReYMeN organizasyonu üzerinden yapılıyor. gh CLI asdafgf olarak giriş yapmış durumda ve Watcher-ReYMeN altında repo oluşturabiliyor.
§
...
§
NemoClaw'dan alinan ozellikler: (1) Skill audience kategorizasyonu — 1.184 SKILL.md'ye audience alani eklendi, GitHub'a push edildi. (2) AGENTS.md — skill repo yapisi, format, commit kurallari tek dosyada. GitHub'da Watcher-ReYMeN/ReYMeN-skills reposunda.
§
...
- DEPLOYMENT: Kayıt sonrası 4 adım: (1) ReYMeN'e kaydet (2) Origin izlerini temizle (3) Obsidian sync (4) GitHub ReYMeN-skills push
