...
def _mock_http_error(code=400, body="Hata"):
    ...
    return urllib.error.HTTPError(
        url="http://test.com", code=code, msg=body,
        hdrs={}, fp=mock_err.fp
    )
...
class TestGoogleOAuthProviderHTTP:
    ...
    def test_callback_handler_basarili(self):
        ...
        token_data = {"access_token": "abc123", "expires_in": 3600,
                      "refresh_token": "ref1", "token_type": "Bearer",
                      "scope": "email profile"}
        user_data = {"id": "user1", "email": "a@b.com",
                     "name": "Test User", "picture": "http://pic"}
    ...
    def test_callback_handler_http_hatasi(self):
        ...
        with patch("urllib.request.urlopen",
                   side_effect=_mock_http_error(400, "invalid_grant")):
    ...
    def test_token_refresh_basarili(self):
        ...
        with patch("urllib.request.urlopen") as m:
            m.return_value = _mock_urlopen(data={
    ...
    def test_token_refresh_http_hatasi(self):
        ...
        with patch("urllib.request.urlopen",
                   side_effect=_mock_http_error(401, "invalid_token")):
    ...
    def test_get_user_info_basarili(self):
        ...
        with patch("urllib.request.urlopen") as m:
            m.return_value = _mock_urlopen(data={
                "sub": "u123", "email": "x@y.com", "name": "User"
            })
    ...
    def test_get_user_info_http_hatasi(self):
        ...
        with patch("urllib.request.urlopen",
                   side_effect=_mock_http_error(403, "forbidden")):
            with pytest.raises(Exception):
...
class TestGitHubOAuthProviderHTTP:
    ...
    def test_callback_handler_basarili(self):
        ...
        with patch("urllib.request.urlopen") as m:
            m.side_effect = [
                _mock_urlopen(data={"access_token": "gh-token",
                                    "token_type": "bearer",
                                    "scope": "repo"}),
                _mock_urlopen(data={"id": 42, "login": "ghuser",
                                    "email": "gh@b.com", "name": "GH User",
                                    "avatar_url": "http://av"}),
            ]
...
class TestDiscordOAuthProviderHTTP:
    ...
    def test_callback_handler_basarili(self):
        ...
        with patch("urllib.request.urlopen") as m:
            m.side_effect = [
                _mock_urlopen(data={"access_token": "dc-tok",
                                    "token_type": "Bearer",
                                    "expires_in": 3600,
                                    "refresh_token": "dc-ref"}),
                _mock_urlopen(data={"id": "12345", "email": "dc@x.com",
                                    "global_name": "DC User", "username": "dcuser",
                                    "avatar": "abc123"}),
            ]
    ...
    def test_callback_handler_avatar_gif(self):
        ...
        with patch("urllib.request.urlopen") as m:
            m.side_effect = [
                ...
                _mock_urlopen(data={"id": "99", "username": "u",
    ...
    def test_callback_handler_http_hatasi(self):
        ...
        with patch("urllib.request.urlopen",
                   side_effect=_mock_http_error(400, "invalid_code")):
            with pytest.raises(Exception):
    ...
    def test_token_refresh_basarili(self):
        ...
        with patch("urllib.request.urlopen") as m:
            m.return_value = _mock_urlopen(data={
                "access_token": "new-dc-tok", "expires_in": 3600,
            })
