...
class _ImportShimFinder:
    def find_spec(self, fullname, path, target=None):
        ...
        try:
            ...
            return ModuleSpec(fullname, importlib.machinery.BuiltinImporter, is_package=False)
        except ImportError:
            return None
        except Exception:
            return None
...
_MISSING_MODULES = [
    "agent", "anayasa_denetcisi", "araclar_ekran", "araclar_makro",
    "araclar_nisan", "araclar_ses", "araclar_telegram", "auxiliary_client",
    "chat_completion_helpers", "context_compressor", "context_engine",
