...
class MockAdapter(GatewayAdapter):
    def __init__(self):
        super().__init__("mock", {})
        self.mesajlar = []
    def baslat(self): self._calisiyor = True; return True
    def durdur(self): self._calisiyor = False; return True
    def durum(self): return {"ad": "mock"}
    def hazir_mi(self): return True
