---
name: red-teaming_godmode_references_step-1-choose-your-attack-mode
description: "Step 1: Choose Your Attack Mode"
title: "Red Teaming Godmode References Step 1 Choose Your Attack Mode"
version: 1.0.0
---
...
|:----:|:---------|
| **Kim** | AI/ML mühendisi |
| **Ne** | Step 1: Choose Your Attack Mode |
| **Nerede** | AI_ML/ |
...
| Want persistent jailbreaking for all queries | ReYMeN Config | Set prefill.json + system_prompt once |
