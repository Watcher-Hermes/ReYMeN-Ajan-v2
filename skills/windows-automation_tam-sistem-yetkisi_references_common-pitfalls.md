...
8. **Gateway komutu büyük harf** — Komut **küçük harfle** yazılmalı: `ReYMeN gateway`; `ReYMeN Gateway` hata verir.
9. **Yanlış Python yorumlayıcısı** — Windows PATH sırasında önce `/c/Users/marko/AppData/Local/Programs/Python/...` yorumlayıcısı gelebilir; `pyautogui` yeni kurulduysa `ReYMeN-ai\\venv` yorumlayıcısında çalıştığından emin ol.
