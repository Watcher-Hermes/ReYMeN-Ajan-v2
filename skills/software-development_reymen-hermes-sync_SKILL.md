---
name: software-development-reymen-ReYMeN-sync
description: When ReYMeN Agent gets updated, Reymen (a derived project) needs to selectively
  absorb the changes. Not all ReYMeN files can be blindly copied — Reymen has custom
  modifications, renamed modules, and a different architecture.
title: Software Development Reymen ReYMeN Sync
version: 1.0.0
---
