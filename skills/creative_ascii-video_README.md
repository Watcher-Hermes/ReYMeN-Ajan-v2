...
Built for [ReYMeN Agent](https://github.com/NousResearch/ReYMeN-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/ReYMeN-agent/skills/creative/ascii-video`](https://github.com/NousResearch/ReYMeN-agent/tree/main/skills/creative/ascii-video) via PR.
