---
name: ReYMeN-muhendislik-analizi
...
tags: [ReYMeN, architecture, engineering, analysis, reference]
category: devops
audience: maintainer
version: 1.0.0
triggers: [ReYMeN-mimari, mühendislik-analizi, 007-ajan, mimari-harita]
...
|:-----|:------|
| **Kim?** | Tüm ajanlar |
| **Ne?** | ReYMeN Agent'in tam mimari analizi — 4 paralel ajan + video analizi ile üretilmiş kapsamlı referans dokümanı. |
| **Nerede?** | DevOps/ |
...
| Bölüm 8 | Yerel ReYMeN Projeleri Envanteri (4 kod tabanı, konum, durum) | `references/08-yerel-ReYMeN-projeleri.md` |

## Kullanım

Bir analiz sorusu aldığında:
1. Konuyu belirle (genel mimari, çekirdek, bellek, skill üretim, entegrasyon, eksikler, 007 ajan)
2. `skill_view(name="ReYMeN-muhendislik-analizi", file_path="references/XX-bolum.md")` ile ilgili reference dosyasını yükle
