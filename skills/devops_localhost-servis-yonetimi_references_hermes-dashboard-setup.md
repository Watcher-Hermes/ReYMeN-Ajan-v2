...
|--------|------|----------|
| ReYMeN Agent Dashboard | 9119 | `ReYMeN dashboard --no-open` |
...
İlk çalıştırmada `ReYMeN dashboard` şu hatayı verir:
```
...
Sonra `ReYMeN dashboard --no-open` tekrar çalıştırılır.
