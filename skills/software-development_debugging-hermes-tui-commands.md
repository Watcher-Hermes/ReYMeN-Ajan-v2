---
name: debugging-ReYMeN-tui-commands
...
metadata:
  ReYMeN:
    tags: [debugging, ReYMeN-agent, tui, slash-commands, typescript, python]
...
|:-----|:------|
| **Kim?** | Tüm ajanlar |
| **Ne?** | Debug ReYMeN TUI slash commands: Python, gateway, Ink UI. |
